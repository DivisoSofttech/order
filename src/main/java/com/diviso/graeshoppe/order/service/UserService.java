...
import com.diviso.graeshoppe.order.config.Constants;
import com.diviso.graeshoppe.order.domain.Authority;
import com.diviso.graeshoppe.order.domain.User;
import com.diviso.graeshoppe.order.repository.AuthorityRepository;
import com.diviso.graeshoppe.order.repository.UserRepository;
import com.diviso.graeshoppe.order.repository.search.UserSearchRepository;
import com.diviso.graeshoppe.order.security.SecurityUtils;
import com.diviso.graeshoppe.order.service.dto.UserDTO;
...
public class UserService {
    ...
    private static User getUser(Map<String, Object> details) {
        ...
        System.out.println("The user details &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&7 "+details);
        return user;
    }
